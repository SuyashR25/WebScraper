...
## Current Limitations & What Does Not Work
...
- **Broad Click Triggers:** The interaction emulator blindly clicks on elements with `role="button"` or `.nav-link` classes. On poorly structured sites, this can trigger unexpected UI modals or unhandled JavaScript errors that might disrupt the page state.
